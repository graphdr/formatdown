...
![](../reference/figures/binding-energy.png)  
*Curve of Binding Energy* by J. Brew is licensed under [CC BY-SA
...
|:--:|:--:|:--:|
| \$\small\mathrm{C}\$–\$\small\mathrm{12}\$ | \$\mathrm{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ | \$\mathrm{^{\small\\ 12}\small\\\\ C}\$ |
| \$\small\mathrm{U}\$–\$\small\mathrm{235}\$ | \$\mathrm{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ | \$\mathrm{^{\small\\ 235}\small\\\\ U}\$ |
...
x <- "C-12"
format_nucl(x)
#> [1] "$\\mathrm{^{\\small\\ 12}\\small\\!\\ C}$"
```

Example 1 renders as: \$\mathrm{^{\small\\ 12}\small\\\\ C}\$.
...
y <- "U-235"
format_nucl(y)
#> [1] "$\\mathrm{^{\\small\\ 235}\\small\\!\\ U}$"
```

Example 2 renders as: \$\mathrm{^{\small\\ 235}\small\\\\ U}\$
...
#> [1] "$\\mathrm{^{\\small\\ 12}_{\\small\\ 6}\\small\\!\\ C}$"
```

Example 3 renders as: \$\mathrm{^{\small\\ 12}\_{\small\\ 6}\small\\\\
C}\$
...
#> [1] "$\\mathrm{^{\\small\\ 235}_{\\small\\ 92}\\small\\!\\ U}$"
```

Example 4 renders as: \$\mathrm{^{\small\\ 235}\_{\small\\ 92}\small\\\\
U}\$
...
Example 5 renders as: \$\mathrm{^{\small\\ 12}\_{\small\\ 6}\small\\\\
C}\$
...
Example 6 renders as: \$\mathrm{^{\small\\ 235}\_{\small\\ 92}\small\\\\
U}\$
...
|:---|:---|:---|:---|:---|
| \$\mathrm{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ | \$\mathit{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ | \$\mathbf{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ | \$\mathsf{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ | \$\mathtt{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ |
| \$\mathrm{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ | \$\mathit{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ | \$\mathbf{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ | \$\mathsf{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ | \$\mathtt{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$ |
| \$\mathrm{^{\small\\ 204}\_{\small\\ 82}\small\\\\ Pb}\$ | \$\mathit{^{\small\\ 204}\_{\small\\ 82}\small\\\\ Pb}\$ | \$\mathbf{^{\small\\ 204}\_{\small\\ 82}\small\\\\ Pb}\$ | \$\mathsf{^{\small\\ 204}\_{\small\\ 82}\small\\\\ Pb}\$ | \$\mathtt{^{\small\\ 204}\_{\small\\ 82}\small\\\\ Pb}\$ |
| \$\mathrm{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ | \$\mathit{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ | \$\mathbf{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ | \$\mathsf{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ | \$\mathtt{^{\small\\ 235}\_{\small\\ 92}\small\\\\ U}\$ |
...
x <- c("H-1", "H-2", "H-3")
format_nucl(x, Z = TRUE)
#> [1] "$\\mathrm{^{\\small\\ 1}_{\\small\\ 1}\\small\\!\\ H}$"
#> [2] "$\\mathrm{^{\\small\\ 2}_{\\small\\ 1}\\small\\!\\ H}$"
#> [3] "$\\mathrm{^{\\small\\ 3}_{\\small\\ 1}\\small\\!\\ H}$"
```

Example 8 renders as: \$\mathrm{^{\small\\ 1}\_{\small\\ 1}\small\\\\
H}\$, \$\mathrm{^{\small\\ 2}\_{\small\\ 1}\small\\\\ H}\$,
\$\mathrm{^{\small\\ 3}\_{\small\\ 1}\small\\\\ H}\$
...
*Examples.*   In this example, the first entry has an incorrect element
symbol and the second has an incorrect mass number.
...
#> c("Carbon-12", "C-40")
#> [1] "$\\mathrm{^{\\small\\ 12}\\small\\!\\ Carbon}$"
#> [2] "$\\mathrm{^{\\small\\ 40}\\small\\!\\ C}$"     
#> [3] "$\\mathrm{^{\\small\\ 12}\\small\\!\\ C}$"
```

Example 9 renders as \$\mathrm{^{\small\\ 12}\small\\\\ Carbon}\$,
\$\mathrm{^{\small\\ 40}\small\\\\ C}\$, \$\mathrm{^{\small\\
12}\small\\\\ C}\$

*Examples.*   If we use the atomic number argument, the letter *Z* is
placed in the subscript.
...
#> in c("Carbon-12", "C-40")
#> [1] "$\\mathrm{^{\\small\\ 12}_{\\small\\ Z}\\small\\!\\ Carbon}$"
#> [2] "$\\mathrm{^{\\small\\ 40}_{\\small\\ Z}\\small\\!\\ C}$"     
#> [3] "$\\mathrm{^{\\small\\ 12}_{\\small\\ 6}\\small\\!\\ C}$"
```

Example 10 renders as \$\mathrm{^{\small\\ 12}\_{\small\\ Z}\small\\\\
Carbon}\$, \$\mathrm{^{\small\\ 40}\_{\small\\ Z}\small\\\\ C}\$,
\$\mathrm{^{\small\\ 12}\_{\small\\ 6}\small\\\\ C}\$
...
#> [1] "$\\mathrm{^{\\small\\ A}\\small\\!\\ E}$"
```

Example 11 renders as: \$\mathrm{^{\small\\ A}\small\\\\ E}\$

*Examples.*   As noted earlier, the usual `Z` argument in this case
places a *Z* in the subscript position.
...
#> [1] "$\\mathrm{^{\\small\\ A}_{\\small\\ Z}\\small\\!\\ E}$"
```

Example 12 renders as: \$\mathrm{^{\small\\ A}\_{\small\\ Z}\small\\\\
E}\$

*Examples.*   Some authors prefer using *X* for the general element
symbol,
...
x <- c("X-A")
format_nucl(x, Z = TRUE, warn = FALSE)
#> [1] "$\\mathrm{^{\\small\\ A}_{\\small\\ Z}\\small\\!\\ X}$"
```

Example 13 renders as: \$\mathrm{^{\small\\ A}\_{\small\\ Z}\small\\\\
X}\$
...
> The most common isotope of Germanium is \$\mathrm{^{\small\\
> 74}\small\\\\ Ge}\$ with a naturally occurring frequency of 36% though
> \$\mathrm{^{\small\\ 72}\small\\\\ Ge}\$ is a close second at 28%.
...
format_nucl(x)
#> [1] "$\\mathrm{^{\\small\\ 1}\\small\\!\\ H}$" 
#> [2] "$\\mathrm{^{\\small\\ 2}\\small\\!\\ H}$" 
#> [3] "$\\mathrm{^{\\small\\ 3}\\small\\!\\ He}$"
#> [4] "$\\mathrm{^{\\small\\ 4}\\small\\!\\ He}$"
#> [5] "$\\mathrm{^{\\small\\ 6}\\small\\!\\ Li}$"
#> [6] "$\\mathrm{^{\\small\\ 7}\\small\\!\\ Li}$"
#> [7] "$\\mathrm{^{\\small\\ 9}\\small\\!\\ Be}$"
```

*Examples.*   In a table, the output can be rendered as,
...
|:---------------:|:---------------------------------------:|
|       H-1       | \$\mathrm{^{\small\\ 1}\small\\\\ H}\$  |
|       H-2       | \$\mathrm{^{\small\\ 2}\small\\\\ H}\$  |
|      He-3       | \$\mathrm{^{\small\\ 3}\small\\\\ He}\$ |
|      He-4       | \$\mathrm{^{\small\\ 4}\small\\\\ He}\$ |
|      Li-6       | \$\mathrm{^{\small\\ 6}\small\\\\ Li}\$ |
|      Li-7       | \$\mathrm{^{\small\\ 7}\small\\\\ Li}\$ |
|      Be-9       | \$\mathrm{^{\small\\ 9}\small\\\\ Be}\$ |

Example 14. {.table}

  

*Examples.*   Adding atomic numbers yields,
...
| Hyphenated form |                   Nuclear notation                    |
|:---------------:|:-----------------------------------------------------:|
|       H-1       | \$\mathrm{^{\small\\ 1}\_{\small\\ 1}\small\\\\ H}\$  |
|       H-2       | \$\mathrm{^{\small\\ 2}\_{\small\\ 1}\small\\\\ H}\$  |
|      He-3       | \$\mathrm{^{\small\\ 3}\_{\small\\ 2}\small\\\\ He}\$ |
|      He-4       | \$\mathrm{^{\small\\ 4}\_{\small\\ 2}\small\\\\ He}\$ |
|      Li-6       | \$\mathrm{^{\small\\ 6}\_{\small\\ 3}\small\\\\ Li}\$ |
|      Li-7       | \$\mathrm{^{\small\\ 7}\_{\small\\ 3}\small\\\\ Li}\$ |
|      Be-9       | \$\mathrm{^{\small\\ 9}\_{\small\\ 4}\small\\\\ Be}\$ |
