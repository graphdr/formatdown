...
\$\small\mathtt{\verb\|"\\\>"\|}\$, but the the argument value set by
the user is `whitespace =` \$\small\mathtt{\verb\|"\\\\\>"\|}\$. One may
also use \$\mathtt{\small\verb\|"\\\\:"\|}\$ or
\$\mathtt{\small\verb\|"\\\\ "\|}\$.
...
The default symbol used in power of ten notation is “\$\small\times\$”,
as in \$\small 3.14 \times 10^{-3}\$. An alternate—often used when the
decimal marker is a comma—is the centered dot, e.g., \$\small 3,14 \cdot
10^{-3}\$.
