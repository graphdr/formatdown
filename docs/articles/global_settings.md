...
![An image of the word 'option'.](options-img.png)  
...
`.qmd` document. The solution, suggested by ([*TeX and LaTeX math
delimiters*, 2024](#ref-Mathjax:2024)), is to use the delimiter pair
...
*TeX and LaTeX math delimiters*. (2024). MathJax Consortium.
