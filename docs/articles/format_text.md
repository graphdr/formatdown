...
![Table of text formatting macros in
formatdown](latex_math_formatting_text_table_2.png)
...
2.  \small \mathrm{Alum\\ 6061}, \small \mathrm{Carbon\\ steel}, \small
    \mathrm{Ni-Cr-Fe\\ alloy}
...
Example 3 renders as:   \small \mathrm{abc}, \small \mathrm{def}, \small
\mathrm{NA}.
...
Example 7 renders as:   \small \mathrm{2026-05-03}.
...
Example 8 renders as:   \small \mathrm{low}, \small \mathrm{med}, \small
\mathrm{high}.
