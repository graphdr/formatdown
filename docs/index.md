...
argument can be set once using
[`formatdown_options()`](https://graphdr.github.io/formatdown/reference/formatdown_options.md).
If desired, we can also change the multiplication symbol to a half-high
dot.
...
- Use the GitHub [Issues](https://github.com/graphdr/formatdown/issues)
  page.
