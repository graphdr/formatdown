...
In professional technical prose, large and small numbers are generally typeset using powers of ten notation. For example, Plank's constant would be typeset as `r format_power(plank, format = "sci")` J/Hz rather than the familiar forms we use in communicating with computers, such as `6.626*10^34` or `6.626E-34`. 
