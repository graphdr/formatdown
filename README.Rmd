...
In an Rmd output, this string prints as: `r format_power(101100, 4, engr_notation = FALSE)`. Because the output in all cases is type character, the `\` symbol in the LaTeX product symbol `\times` is escaped, that is, the function yields `\\times`. 
