...
<!-- badges: start -->
[![Version number](https://www.r-pkg.org/badges/version/formatdown)](https://cran.r-project.org/package=formatdown)
...
[![Codecov test coverage](https://codecov.io/gh/graphdr/formatdown/graph/badge.svg)](https://app.codecov.io/gh/graphdr/formatdown)
<!-- badges: end -->
...
: Convert a character vector of chemical isotopes in hyphenated form to a math-delimited character vector in nuclear form: each element symbol with its mass number superscript and the optional atomic number subscript. 
